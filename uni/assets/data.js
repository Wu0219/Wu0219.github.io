...
(function (root) {
  ...
  var PROSPECT_DIMS = [
    {
      key: 'major', label: '专业前景', weight: 0.27,
    ...
    {
      key: 'schoolTier', label: '学校层次', weight: 0.22,
      hint: '决定简历第一轮筛选能不能过',
      options: [
        { v: 1.34, label: 'C9 / QS 前 50' },
        { v: 1.24, label: '985 / QS 51-100' },
        { v: 1.14, label: '211 / QS 101-200' },
        { v: 1.06, label: '双一流学科 / QS 201-400' },
        { v: 1.00, label: '普通一本 / QS 401-800', hint: '基准档' },
        { v: 0.90, label: '普通二本 / 无排名海外院校' },
        { v: 0.80, label: '民办本科 / 独立学院' },
        { v: 0.72, label: '专科 / 高职' }
      ]
    },
    {
      key: 'localJobs', label: '本地就业机会', weight: 0.19,
    ...
    {
      key: 'internship', label: '实习可得性', weight: 0.14,
      options: [
    ...
    },
    {
      ...
      key: 'seniorOutcome', label: '学长学姐的就业情况', weight: 0.18,
